...
## We can start with a Cox Model ... {.flexbox .vleft .build}
...
## Hopefully, the Mixed Model is there! {.flexbox .vleft .build}
...
## What can we do with a Joint Model? {.flexbox .vleft .build}
...
## The best part? {.flexbox .vleft .build}
...
## What is a Joint Model? With equations! {.flexbox .vleft .build}
...
## The longitudinal component {.flexbox .vleft .build}
...
## The time-to-event component {.flexbox .vleft .build}
...
## A more "naive" approach! {.flexbox .vleft .build}
...
## Time to generate fake data! {.flexbox .vleft .build}
...
## What could we expect? {.flexbox .vleft .build}
...
## Not exactly what we expected ... {.flexbox .vcenter}
...
* $\Rightarrow$ Use "Two-Step" as a screening approach and refine with The Joint Model
